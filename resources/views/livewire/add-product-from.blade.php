    ...
    <form wire:submit="save">
      ...
      <div
        ...
        <div class="sm:col-span-9">
          <div>
            <input id="af-submit-application-full-name" wire:model="product_name" type="text"
        ...
        <div class="sm:col-span-9">
          <input id="af-submit-application-price" wire:model="product_Price" type="number"
      ...
      <br
        ...
        <div class="sm:col-span-9 ">
          @if ($photo)
            ...
            @else
              <img src="{{ asset('images/2.jpg')}}" alt="default image" height="300px" width="300px" class="rounded-lg">
          @endif
        </div>
        <!-- End Col -->
        <div class="sm:col-span-3">
        ...
        <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
          ...
          <label for="file" class="sr-only">Choose Image (Upload only 1MB)</label>
